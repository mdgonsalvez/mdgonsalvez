...
- **Version / Build:** `1.0` / `1` (`displayVersion` / `bundleVersion` in
  ...
  release.
- **Orientations / Devices:** portrait + landscape, **iPhone & iPad** (universal, already set).
...
- The app is **universal**, so provide both an **iPhone 6.5″** (1242 × 2688) and
  an **iPad 13″** (2048 × 2732) set. Now that the app is on the store you can
  install it on a real iPhone and capture native iPhone screenshots.
